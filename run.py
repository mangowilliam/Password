...
def main():
    ...
    while True:
        print(" cl - create a login and save login, lg - login into your account")
        ...
        if short_code == 'cl':
            ...
            print("\n")
            print(f"{login_name} welcome to Password Locker")
            print("\n")
            ...
            if log_in(login_name, login_password) == None:
                ...
                print("\n")
                print(f'''{login_name} welcome to your Credentials\n
